...
XLibur is a fork of [ClosedXML v0.105.0](https://github.com/ClosedXML/ClosedXML/) (May 2025), created
to ship patches and improvements that didn't land upstream. Namespaces are prefixed with `XLibur`.
